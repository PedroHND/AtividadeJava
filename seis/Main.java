...
public class Main {
	public static void main(String[] args){
		...
		for(int i=0;i<4;i++) {
			...
			verificarRespostas(scan, p, i, respostas);
				...
				System.out.println("Erro, tente executar novamente o programa.");
				verificarRespostas(scan, p, i, respostas);
			}
		}
	...
	public static void verificarRespostas(Scanner s, Participante par,int aux, int[] res){
		...
		num = s.next();
			...
			break;
			default:
				System.out.println("Resposta Invalida, tente uma resposta válida");
